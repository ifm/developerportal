...
- `diagnostic.py` shows how to retrieve diagnostic information on request or asynchronously whevener an error occurs. Monitoring the diagnostic at all times is crutial to ensure good funtioning of the application.
