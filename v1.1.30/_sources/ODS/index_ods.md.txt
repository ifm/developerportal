...
ODS doesn't follow any safety regulations: for example ASIL-level or similar, and can therefore not replace a typical application of safety devices such as safety LiDAR scanners.
